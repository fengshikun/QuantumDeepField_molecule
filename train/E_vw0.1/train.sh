...
python ../train_fp.py $dataset $basis_set $radius $grid_interval $dim $layer_functional $hidden_HK $layer_HK $operation $batch_size $lr $lr_decay $step_size $iteration $setting $num_workers $lambdaV --use_d --exch_scale=1 --en_scale=0.529 --eprefix=step1 --orbit_lrdecay=1
